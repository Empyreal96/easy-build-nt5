@echo off
if exist %~d0\binaries.x86fre goto x86fre
if exist %~d0\binaries.x86chk goto x86chk
...
if exist %~d0\binaries.x86fre\duser.dll del %~dp0\win2003_x86-missing-binaries_v2\binaries.x86fre\duser.dll
if exist %~d0\binaries.x86fre\duser.dll del %~dp0\win2003_x86-missing-binaries_v2\binaries.x86fre\duser.pdb
...
if exist %~d0\binaries.x86chk\duser.dll del %~dp0\win2003_x86-missing-binaries_v2\binaries.x86chk\duser.dll
if exist %~d0\binaries.x86chk\duser.dll del %~dp0\win2003_x86-missing-binaries_v2\binaries.x86chk\duser.pdb
